...
$faculties = $payload->findMany()->fetchAll();
$count = $payload->findMany()->rowCount();

if (isset($_POST['add'])) {
    $payload->store(new Faculty($_POST['dep_name'], $_POST['dep_fee']));
    header("Location: .");
}
...
<head>
    ...
    <title>Navasms - Departments</title>
                ...
                <div class="container grid px-6 mx-auto">
                        ...
                        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            ...
                            <label class="block text-sm">
                                ...
                                <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                                    <input name="dep_name" type="text" placeholder="dep name..." class="block w-full pl-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input" />
                            ...
                            <label class="block mt-4 text-sm">
                                <span class="text-gray-700 dark:text-gray-400">Department Fee</span>
                                <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                                    <input name="dep_fee" type="text" placeholder="dep fees..." class="block w-full pl-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input" />
                                    <div class="absolute inset-y-0 flex items-center ml-3 pointer-events-none">
                                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="mb-6 flex align-middle justify-between">
                        <h4 class="text-lg font-semibold text-gray-600 dark:text-gray-300">
                            ...
                            if ($count != 0) {
                            ?>
                        <div class="w-full overflow-hidden rounded-lg <?php if ($count == 0)  echo "";
                                                                        else echo "shadow-xs"; ?> ">
                                ...
                                <table class="w-full whitespace-no-wrap">
                                    <thead>
                                        <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                            <th class="px-4 py-3">Deprtment Name</th>
                                            <th class="px-4 py-3">Deprtment Fees</th>
                                    ...
                                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                        ...
                                        ?>
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3 text-sm">
                                                    <?php echo $faculty['faculty_price'] ?>
                                                </td>
                                                <td class="px-4 py-3">
                                                    <div class="flex items-center space-x-4 text-sm">
                                                        <a href="update_faculty.php?faculty_id=<?php echo $faculty['faculty_name'] ?>">
                                        ...
                                        <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 transform translate-y-1/2" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0  transform translate-y-1/2" @click.away="closeModal" @keydown.escape="closeModal" class="w-full px-6 py-4 overflow-hidden bg-white rounded-t-lg dark:bg-gray-800 sm:rounded-lg sm:m-4 sm:max-w-xl" role="dialog" id="modal">
                                            ...
                                            <div class="mt-4 mb-6">
                                                ...
                                                <p class="text-sm text-gray-700 dark:text-gray-400">
                                                    Are you sure you want to delete <b>[<?php echo $faculty['faculty_name'] ?>]</b>,if yes please confirm your option.
                                                </p>
                                            </div>
                                            <footer class="flex flex-col items-center justify-end px-6 py-3 -mx-6 -mb-4 space-y-4 sm:space-y-0 sm:space-x-6 sm:flex-row bg-gray-50 dark:bg-gray-800">
                                                ...
                                                <a href="delete_faculty.php?faculty_id=<?php echo $faculty['faculty_name'] ?>">
