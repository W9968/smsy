...
$subject = $payload->findOne($_id);


if (isset($_POST['update'])) {
    $payload->update(new Subject($_POST['subject_name'], $_POST['duration']), $_id);
                        ...
                        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            ...
                            <label class="block text-sm">
                                ...
                                <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                                    <input value="<?php echo $subject['subject_name'] ?>" name="subject_name" type="text" placeholder="course name..." class="block w-full pl-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input" />
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                                    <input value="<?php echo $subject['duration'] ?>" name="duration" type="text" placeholder="period..." class="block w-full pl-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input" />
                                    <div class="absolute inset-y-0 flex items-center ml-3 pointer-events-none">
                                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
